...
document.getElementById("readytostart").addEventListener("click",function(){
  setInterval(drawScreen,1000)
});

function myFunction(){
$( document ).ready(function() {
  $( "#timeout" ).toggle( "explode" );
});
}
myVar = setTimeout(myFunction, 60000);

var questions = [
	{
		question: "What falling object inspired Isaac Newton's theories about gravity?",
		answer: "apple"
	},
	{
		question: "What color is a NYC taxi?",
		answer: "yellow"
	},
	{
		question: "Where in the world does the largest tropical rainforest grow?",
		answer: "amazon"
	},
	{
		question: "In which country do the famous pyramids of Giza stand?",
		answer: "egypt"
	},
	{
		question: "What kind of reptile is the chameleon?",
		answer: "lizard"
	},
	{
		question: "In the Arabian Nights, who met with 40 thieves?",
		answer: "ali baba"
	},
	{
		question: "According to the fairy tale, who had to leave the ball before midnight",
		answer: "cinderella"
	},
	{
	...
	{
		question: "The famous speech by Dr. Martin Luther King Jr. I have a ______________ ",
		answer: "dream"
	}
]
